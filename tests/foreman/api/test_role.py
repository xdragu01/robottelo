...
class TestCannedRole:
    ...
    def create_org_admin_user(self, role_taxos, user_taxos):
        ...
        :param dict role_taxos: Role taxonomiest specified as dictionary containing 'org' and 'loc' values
        :param dict user_taxos: User taxonomiest specified as dictionary containing 'org' and 'loc' values
    ...
    def create_simple_user(self, filter_taxos, role=None):
        ...
        :param dict filter_taxos: Filter taxonomiest specified as dictionary containing 'org' and 'loc' values
    ...
    @tier2
    def test_positive_force_unlimited(self, role_taxonomies):
